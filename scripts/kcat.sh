echo "kafkacat -b kafka:29092 -q -u -X auto.offset.reset=earliest -t price-update-topic | \
  jq --compact-output --unbuffered \
      ...
      }' | kafkacat -b kafka:29092 -t price-update-topic-schema -P -T -u | jq --unbuffered '.'"